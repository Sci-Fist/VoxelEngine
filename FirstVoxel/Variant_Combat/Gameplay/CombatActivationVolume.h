 ...
 */
UCLASS()
class FIRSTVOXEL_API ACombatActivationVolume : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	/**
	 * Set to true after the first player entry so subsequent overlaps
	 * (re-entry, NPCs, projectiles) do not re-fire the activation list.
	 */
