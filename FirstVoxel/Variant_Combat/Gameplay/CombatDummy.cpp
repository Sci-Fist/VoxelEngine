...
{
	// This actor never needs to update per-frame — disable ticking entirely.
	// Every actor with bCanEverTick = true is registered with UE's tick system
	// and polled each frame even if Tick() does nothing, wasting CPU.
