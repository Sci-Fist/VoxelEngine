 ...
 */
UCLASS(abstract)
class APlatformingCharacter : public AFirstVoxelCharacter
{
	GENERATED_BODY()
...
protected:
	...
	/**
	 * Gravity scale captured from CharacterMovementComponent at construction time.
	 * Used by EndDash() to restore gravity after a dash without hardcoding a magic constant.
	 */
