// VoxelWaterSimulator.cpp  [canonical location: Voxel/Water/]
// Cellular-automata water simulation — gravity flow, lateral spread, sources.
...
TArray<FIntVector> FVoxelWaterSimulator::Step()
{
    ...
    for (auto& Pair : ChunkMap)
    {
        ...
        // Bottom-to-top so gravity propagates naturally each tick.
