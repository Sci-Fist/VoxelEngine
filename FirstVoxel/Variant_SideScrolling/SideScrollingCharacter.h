 ...
 */
UCLASS(abstract)
class ASideScrollingCharacter : public AFirstVoxelCharacter
{
	GENERATED_BODY()
...
protected:
	...
	/** Soft collision reset timer */
	FTimerHandle SoftCollisionTimer;
...
public:
	...
	/** Resets soft collision via timer */
	void ResetSoftCollision();
